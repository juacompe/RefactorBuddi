...
public class DocumentImpl extends AbstractDocument implements ModelObject, Document {
	...
	private void doBackupDataFile() {
		...
		try{
			if (getFile() != null){
				//Use a rotating backup file, of form 'Data.X.org.homeunix.thecave.buddi'
...
//		for (BudgetPeriodBean bpb : dataModel.getBudgetPeriodsUntil().values()) {
...
//		sb.append("\n--Budget Periods--\n");
//		List<String> periodDates = new LinkedList<String>(dataModel.getBudgetPeriodsUntil().keySet());
