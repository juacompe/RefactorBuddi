...
public class BudgetCategoryImpl extends SourceImpl implements BudgetCategory {
	...
	public long getAmount(Date startDate, Date endDate){
        ...
        if (getBudgetPeriodType().getStartOfBudgetPeriod(startDate).equals(
            ...
            double total = getAmountFromPeriod(startDate, endDate);
			return (long) total;
		}
		...
		if (getBudgetPeriodType().getBudgetPeriodOffset(startDate, 1).equals(
            ...
            double totalStartPeriod = getAmountFromPeriod(startDate, endDateOfFirstBudgetPeriod);
            ...
            double totalEndPeriod = getAmountFromPeriod(startOfLastBudgetPeriod, endDate);
    ...
    private double getAmountFromPeriod(Date startDate, Date endDate) {
